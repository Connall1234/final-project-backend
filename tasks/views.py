...
# below worked for the overdue count but broke the rest 
...
#below we will try a third approach 
...
class TaskList(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        # The context variable is not used in the response, so it's not necessary to include it
        return queryset  # Return filtered queryset for the current user
